...
`CoreNovus/convilyn-edge` is a **public mirror** of source maintained in Convilyn's
...
```
you fork convilyn-edge  ──PR──▶  convilyn-edge   ──upstreamed──▶  monorepo PR
                                                              │ full CI
                                                              ▼
...
```bash
git clone https://github.com/CoreNovus/convilyn-edge.git
cd convilyn-edge
